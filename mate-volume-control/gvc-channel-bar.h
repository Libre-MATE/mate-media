...
#define GVC_CHANNEL_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GVC_TYPE_CHANNEL_BAR, GvcChannelBar))
#define GVC_CHANNEL_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GVC_TYPE_CHANNEL_BAR, GvcChannelBarClass))
#define GVC_IS_CHANNEL_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), GVC_TYPE_CHANNEL_BAR))
#define GVC_IS_CHANNEL_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), GVC_TYPE_CHANNEL_BAR))
#define GVC_CHANNEL_BAR_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GVC_TYPE_CHANNEL_BAR, GvcChannelBarClass))
...
void gvc_channel_bar_set_icon_name(GvcChannelBar *bar, const gchar *icon_name);
...
void gvc_channel_bar_set_show_icons(GvcChannelBar *bar, gboolean show_mute);
