...
#define GVC_SPEAKER_TEST(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GVC_TYPE_SPEAKER_TEST, GvcSpeakerTest))
#define GVC_SPEAKER_TEST_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GVC_TYPE_SPEAKER_TEST, GvcSpeakerTestClass))
#define GVC_IS_SPEAKER_TEST(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), GVC_TYPE_SPEAKER_TEST))
#define GVC_IS_SPEAKER_TEST_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), GVC_TYPE_SPEAKER_TEST))
#define GVC_SPEAKER_TEST_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GVC_TYPE_SPEAKER_TEST, GvcSpeakerTestClass))
